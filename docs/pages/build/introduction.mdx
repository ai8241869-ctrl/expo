...
<BoxLink
  ...
  Icon={Cube01Icon}
/>npm install --global eas-cli && npx create-expo-app httpstailor-flow-mdabdurrhman302replitapp && cd httpstailor-flow-mdabdurrhman302replitapp && eas init --id 5dec5d7c-0a0d-40dd-aa68-78dda3852b0a
